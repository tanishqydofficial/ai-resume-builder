...
export class Backend implements backendInterface {
    ...
    async analyzeSkills(arg0: Array<string>): Promise<SkillAnalysis> {
    ...
    async calculateAtsScore(arg0: Array<ExperienceEntry>, arg1: Array<ProjectEntry>): Promise<AtsResult> {
        if (this.processError) {
            try {
    ...
    async enhanceBullets(arg0: Array<string>): Promise<Array<EnhancedBullet>> {
        if (this.processError) {
            try {
