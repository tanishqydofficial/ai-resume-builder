import { c as createLucideIcon, r as reactExports, j as jsxRuntimeExports, b as useNavigate, u as useResumeStore, e as Skeleton, a as cn, C as Check } from "./index-CZkR6vSu.js";
import { B as Button, C as ChevronLeft, a as Badge } from "./badge-Cg3yWkFE.js";
import { u as useAnalyzeSkills, a as useCalculateAtsScore, b as useEnhanceBullets, C as ChevronRight } from "./useQueries-vucnsK7G.js";
...
function AtsRing({ score }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-36 h-36", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-muted-foreground mt-0.5", children: "out of 100" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: cn("text-sm font-bold", getScoreColor(score)), children: getScoreLabel(score) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Applicant Tracking System" })
            ]
          }
        )
      ]
...
function SkillCategory({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: skills.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground italic", children: "None detected" }) : skills.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Badge,
      {
        variant: "outline",
        className: cn("text-xs border font-medium", colorMap[color2]),
        children: s
      },
      s
    )) })
...
function ResultsSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "results_page.loading_state", children: [
    ...
    motion.div,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-0.5 text-muted-foreground text-xs shrink-0", children: "Before" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground line-through leading-relaxed", children: bullet.original })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-0.5 text-accent text-xs font-semibold shrink-0", children: "After" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground leading-relaxed font-medium", children: bullet.enhanced })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-3 pt-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
              ...
              children: bullet.improvement
            }
          ),
          accepted ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1 text-xs text-accent font-semibold", children: [
...
function ResultsPage() {
  ...
  const { skillAnalysis, atsResult, enhancedBullets, isLoading, error } = analysisResults;
  const [acceptedBullets, setAcceptedBullets] = reactExports.useState(
    /* @__PURE__ */ new Set()
  );
  ...
  const hasData = resumeData.personalInfo.fullName.trim().length > 0 || resumeData.skills.length > 0;
  ...
  reactExports.useEffect(() => {
    ...
    Promise.all([
      ...
      allBullets.length > 0 ? enhanceBulletsHook.mutateAsync(allBullets) : Promise.resolve([])
  ...
  function handleAcceptBullet(original, enhanced) {
    setAcceptedBullets((prev) => /* @__PURE__ */ new Set([...prev, original]));
    setAnalysisResults({
      enhancedBullets: enhancedBullets.map(
        (eb) => eb.original === original ? { ...eb, original: enhanced } : eb
      )
    });
  ...
  const hasResults = !!(skillAnalysis || atsResult || enhancedBullets.length > 0);
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ResultsSkeleton, {});
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "results_page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl text-foreground tracking-tight", children: "AI Analysis Results" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Your resume has been analyzed — review the insights and enhance your content." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Button,
    ...
    !hasResults && !error && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "bg-card border border-border rounded-xl p-10 text-center space-y-3",
        "data-ocid": "results_page.empty_state",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Brain, { className: "w-10 h-10 text-muted-foreground mx-auto" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground", children: "No analysis data yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Submit your resume form to run AI/ML analysis." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              onClick: () => {
    ...
    hasResults && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 self-start", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-base", children: "ATS Score" })
            ] }),
            atsResult ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(AtsRing, { score: atsScore }),
              atsResult.matchedKeywords.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-bold text-muted-foreground uppercase tracking-widest", children: "Matched Keywords" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: atsResult.matchedKeywords.map((kw) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Badge,
                  {
                    variant: "secondary",
            ...
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center", children: "No ATS data available." })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-5", children: [
        skillAnalysis && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-base", children: "Skill Categorization" })
              ] }),
              skillAnalysis.categoryExplanation && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: skillAnalysis.categoryExplanation }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-5", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  SkillCategory,
                  {
                    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Wrench, { className: "w-3.5 h-3.5" }),
                    label: "Tools",
        ...
        atsResult && atsResult.suggestions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 16 },
            animate: { opacity: 1, y: 0 },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-base", children: "Improvement Suggestions" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: atsResult.suggestions.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
                  className: "flex items-start gap-2.5 text-sm text-foreground py-1",
                  "data-ocid": `results_page.suggestion.${i + 1}`,
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-3.5 h-3.5 mt-0.5 text-primary flex-shrink-0" }),
        ...
        enhancedBullets.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            initial: { opacity: 0, y: 16 },
            animate: { opacity: 1, y: 0 },
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-base", children: "Enhanced Bullet Points" })
                ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground", children: [
                ...
                " to apply the AI-improved version to your resume."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: enhancedBullets.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                BulletCard,
                {
                  bullet: b,
                  index: i,
